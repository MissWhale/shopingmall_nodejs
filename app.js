...
{//관리자###################################관리자######################################관리자
        ...
        app.get("/product",function(req,res){
                if(req.session.displayname){
                        var dname=req.session.displayname;
                        res.render('product',{name:dname,id:req.session.user});
                }else{
                        res.render('product');
                }
        })
        ...
        app.post("/productupload",function(req,res){
                ...
                var sql='insert into product(pkind,pnum,name,comp,count,price,ptext,simg,bimg) values(?,?,?,?,?,?,?,?,?)';
                con.query(sql,[pro.kind,pro.num,pro.name,pro.comp,pro.count,pro.price,pro.text,pro.simg,pro.bimg],function(err,result){
                        if(err) console.log(err);
                        else{
